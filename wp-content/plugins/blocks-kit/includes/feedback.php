...
public function display_admin_notice() {
        ...
        if ( isset( $screen->base ) && 'plugins' == $screen->base ) {
                ...
                */
                sprintf( esc_html( 'You have been using the %1$s plugin for %2$s now, do you like it? If so, please leave us a review with your feedback!', 'spam-destroyer' ),   esc_html($this->name), esc_html($time)) . '</p>
                </div>';
        }
}

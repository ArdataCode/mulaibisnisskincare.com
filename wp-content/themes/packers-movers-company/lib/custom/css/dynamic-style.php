...
function packers_movers_company_dynamic_css(){
    ...
    $packers_movers_company_packers_movers_company_logo_width_range = get_theme_mod('packers_movers_company_logo_width_range', $packers_movers_company_default['packers_movers_company_logo_width_range']);
    ...
    max-width:  <?php echo esc_attr($packers_movers_company_packers_movers_company_logo_width_range); ?>px;
    }

...
if (!function_exists('packers_movers_company_header_style')) :
    ...
    {
        $packers_movers_company_header_text_color = get_header_textcolor();

        if (get_theme_support('custom-header', 'default-text-color') === $packers_movers_company_header_text_color) {
            return;
        }
        ...
        <style type="text/css">
            <?php
                if ( 'blank' == $packers_movers_company_header_text_color ) :
            ?>
            ...
            .site-description {
                color: #<?php echo esc_attr( $packers_movers_company_header_text_color ); ?>;
            }

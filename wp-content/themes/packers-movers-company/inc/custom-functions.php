...
if( !function_exists( 'packers_movers_company_fonts_url' ) ) :
    ...
    function packers_movers_company_fonts_url(){
        ...
        $packers_movers_company_font_families = array(
            'Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900',
        );

        $packers_movers_company_fonts_url = add_query_arg( array(
            'family' => implode( '&family=', $packers_movers_company_font_families ),
            'display' => 'swap',
        ), 'https://fonts.googleapis.com/css2' );

        return esc_url_raw($packers_movers_company_fonts_url);
...
if( !function_exists('packers_movers_company_footer_content_widget') ):
    ...
    function packers_movers_company_footer_content_widget(){
        ...
        $packers_movers_company_default = packers_movers_company_get_default_theme_options();
            ...
            $packers_movers_company_footer_column_layout = absint(get_theme_mod('footer_column_layout', $packers_movers_company_default['footer_column_layout']));
            $packers_movers_company_footer_sidebar_class = 12;
            if($packers_movers_company_footer_column_layout == 2) {
                $packers_movers_company_footer_sidebar_class = 6;
            }
            if($packers_movers_company_footer_column_layout == 3) {
                $packers_movers_company_footer_sidebar_class = 4;
            }
            ?>
            ...
            <div class="footer-widgetarea">
                <div class="wrapper">
                    <div class="column-row">
                        <?php for ($i=0; $i < $packers_movers_company_footer_column_layout; $i++) {
                            ?>
                            <div class="column <?php echo 'column-' . absint($packers_movers_company_footer_sidebar_class); ?> column-sm-12">
                                <?php dynamic_sidebar('packers-movers-company-footer-widget-' . $i); ?>
                            </div>
                       <?php } ?>
                    ...
                    <div class="column column-9">
                        <div class="footer-credits">
                            ...
                            <div class="footer-copyright">
                                <?php
                                $packers_movers_company_packers_movers_company_footer_copyright_text = wp_kses_post( get_theme_mod( 'packers_movers_company_footer_copyright_text', $packers_movers_company_default['packers_movers_company_footer_copyright_text'] ) );
                                    echo esc_html( $packers_movers_company_packers_movers_company_footer_copyright_text );
                                    echo '<br>';
                                    echo esc_html__('Theme: ', 'packers-movers-company') . '<a href="' . esc_url('https://omegathemes.com/wordpress/free-packers-wordpress-theme/') . '" title="' . esc_attr__('Packers Movers Company ', 'packers-movers-company') . '" target="_blank"><span>' . esc_html__('Packers Movers Company ', 'packers-movers-company') . '</span></a>' . esc_html__('By ', 'packers-movers-company') . '  <span>' . esc_html__('OMEGA ', 'packers-movers-company') . '</span>';
                        ...
                        $packers_movers_company_featured_image = isset( $packers_movers_company_featured_image[0] ) ? $packers_movers_company_featured_image[0] : ''; ?>
                          ...
                          <div class="swiper-slide main-carousel-item">
                                  ...
                                  <div class="entry-thumbnail">
                                      <div class="data-bg data-bg-large" data-background="<?php echo esc_url($packers_movers_company_featured_image); ?>">
...
if( !function_exists( 'packers_movers_company_sanitize_sidebar_option_meta' ) ) :
    ...
    function packers_movers_company_sanitize_sidebar_option_meta( $input ){
        ...
        if( in_array( $input,$packers_movers_company_metabox_options ) ){
...
if( !function_exists( 'packers_movers_company_sanitize_pagination_meta' ) ) :

    // Sidebar Option Sanitize.
    function packers_movers_company_sanitize_pagination_meta( $input ){

        $packers_movers_company_metabox_options = array( 'Center','Right','Left');
        if( in_array( $input,$packers_movers_company_metabox_options ) ){
                ...
                <div class="wrapper">
                    ...
                    <div class="swiper-container theme-services-carousel swiper-container" <?php echo $packers_movers_company_rtl; ?>>
                        <div class="swiper-wrapper">
                            ...
                            $packers_movers_company_services_featured_image = wp_get_attachment_image_src(get_post_thumbnail_id(), 'large');
                            $packers_movers_company_services_featured_image = isset( $packers_movers_company_services_featured_image[0] ) ? $packers_movers_company_services_featured_image[0] : ''; ?>
                                <div class="swiper-slide main-carousel-item">
                                    <div class="theme-services-post">
                                        <div class="entry-thumbnail">
                                            <div class="data-bg data-bg-large" data-background="<?php echo esc_url($packers_movers_company_services_featured_image); ?>">
                                                <a href="<?php the_permalink(); ?>" class="theme-image-responsive" tabindex="0"></a>
                                            </div>
                                            <?php packers_movers_company_post_format_icon(); ?>
                                        </div>

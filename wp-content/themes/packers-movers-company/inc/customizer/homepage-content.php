...
$wp_customize->add_section( 'packers_movers_company_header_banner_setting',
    array(
    'title'      => esc_html__( 'Slider Settings', 'packers-movers-company' ),
    'priority'   => 10,
    'capability' => 'edit_theme_options',
    'panel'      => 'packers_movers_company_theme_home_pannel',
    )
);

$wp_customize->add_setting('packers_movers_company_display_header_title',
    array(
        'default' => $packers_movers_company_default['packers_movers_company_display_header_title'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'packers_movers_company_sanitize_checkbox',
    )
);
$wp_customize->add_control('packers_movers_company_display_header_title',
    array(
        'label' => esc_html__('Enable / Disable Title', 'packers-movers-company'),
        'section' => 'title_tagline',
        'type' => 'checkbox',
    )
);

$wp_customize->add_setting('packers_movers_company_display_header_text',
    array(
...
$wp_customize->add_control('packers_movers_company_display_header_text',
    array(
        'label' => esc_html__('Enable / Disable Tagline', 'packers-movers-company'),
        'section' => 'title_tagline',
        'type' => 'checkbox',
    )
);
...
$wp_customize->add_control('packers_movers_company_header_banner',
    array(
        ...
        'section' => 'packers_movers_company_header_banner_setting',
        'type' => 'checkbox',
    )
);
...
$wp_customize->add_section( 'packers_movers_company_header_category_setting',
    array(
...
$wp_customize->add_control('packers_movers_company_services',
    array(
        ...
        'section' => 'packers_movers_company_header_category_setting',
        'type' => 'checkbox',
    )
);

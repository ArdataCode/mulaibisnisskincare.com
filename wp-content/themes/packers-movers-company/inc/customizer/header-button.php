...
// Header Section.
$wp_customize->add_section( 'packers_movers_company_button_header_setting',
	array(
...
$wp_customize->add_control( 'packers_movers_company_header_layout_topbar_text',
    ...
    'section'  => 'packers_movers_company_button_header_setting',
    'type'     => 'text',
    )
);
...
$wp_customize->add_setting('packers_movers_company_sticky',
    array(
        'default' => $packers_movers_company_default['packers_movers_company_sticky'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'packers_movers_company_sanitize_checkbox',
    )
);
$wp_customize->add_control('packers_movers_company_sticky',
    array(
        'label' => esc_html__('Enable Sticky Header', 'packers-movers-company'),
        'section' => 'packers_movers_company_button_header_setting',
        'type' => 'checkbox',
    )
);

$wp_customize->add_setting('packers_movers_company_theme_loader',
    array(
        'default' => $packers_movers_company_default['packers_movers_company_theme_loader'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'packers_movers_company_sanitize_checkbox',
    )
);
$wp_customize->add_control('packers_movers_company_theme_loader',
    array(
        'label' => esc_html__('Enable Preloader', 'packers-movers-company'),
        'section' => 'packers_movers_company_button_header_setting',
        'type' => 'checkbox',
    )
);
...
function packers_movers_company_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'colors' )->panel = 'packers_movers_company_theme_colors_panel';
	$wp_customize->get_section( 'colors' )->title = esc_html__('Color Options','packers-movers-company');
	$wp_customize->get_section( 'title_tagline' )->panel = 'packers_movers_company_theme_general_settings';
	$wp_customize->get_section( 'header_image' )->panel = 'packers_movers_company_theme_general_settings';
	$wp_customize->get_section( 'background_image' )->panel = 'packers_movers_company_theme_general_settings';
	...
	$wp_customize->add_panel( 'packers_movers_company_theme_general_settings',
		array(
	...
	$wp_customize->add_panel( 'packers_movers_company_theme_colors_panel',
		array(
	...
	// Theme Options Panel.
	$wp_customize->add_panel( 'packers_movers_company_theme_footer_option_panel',
		array(
	...
	// Template Options
	$wp_customize->add_panel( 'packers_movers_company_theme_home_pannel',
		array(
	...
	// Theme Addons Panel.
	$wp_customize->add_panel( 'packers_movers_company_theme_addons_panel',
		array(
			'title'      => esc_html__( 'Theme Addons', 'packers-movers-company' ),
			'priority'   => 5,
			'capability' => 'edit_theme_options',
		)
	);
	...
	// Theme Options Panel.
	$wp_customize->add_panel( 'packers_movers_company_theme_option_panel',
		array(
	...
	$wp_customize->add_setting('packers_movers_company_logo_width_range',
	    array(
	        'default'           => $packers_movers_company_default['packers_movers_company_logo_width_range'],
	        'capability'        => 'edit_theme_options',
	        'sanitize_callback' => 'packers_movers_company_sanitize_number_range',
	    )
	);
	$wp_customize->add_control('packers_movers_company_logo_width_range',
	    array(

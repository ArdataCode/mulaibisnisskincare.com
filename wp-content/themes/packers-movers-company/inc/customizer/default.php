...
if ( ! function_exists( 'packers_movers_company_get_default_theme_options' ) ) :
	function packers_movers_company_get_default_theme_options() {
		...
		// Options.
        $packers_movers_company_defaults['packers_movers_company_logo_width_range']                                  = 300;
		$packers_movers_company_defaults['global_sidebar_layout']					            = 'right-sidebar';
        $packers_movers_company_defaults['packers_movers_company_theme_loader']                 = 0;
		...
		$packers_movers_company_defaults['packers_movers_company_footer_copyright_text'] 				     = esc_html__( 'All rights reserved.', 'packers-movers-company' );
        ...
        $packers_movers_company_defaults['packers_movers_company_display_archive_post_sticky_post']            = 1;
        $packers_movers_company_defaults['packers_movers_company_display_archive_post_category']            = 1;
        $packers_movers_company_defaults['packers_movers_company_display_archive_post_title']            = 1;
        $packers_movers_company_defaults['packers_movers_company_display_archive_post_content']            = 1;
        $packers_movers_company_defaults['packers_movers_company_display_archive_post_button']            = 1;
        ...
        $packers_movers_company_defaults['packers_movers_company_display_header_title']                = 1;
        $packers_movers_company_defaults['packers_movers_company_services']               	        = 0;
        $packers_movers_company_defaults['packers_movers_company_sticky']                 = 0;

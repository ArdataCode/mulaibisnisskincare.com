...
if (empty($packers_movers_company_post_sidebar)) {
    $packers_movers_company_global_sidebar_layout = esc_html( get_theme_mod( 'global_sidebar_layout',$packers_movers_company_default['global_sidebar_layout'] ) );
} else {
    $packers_movers_company_global_sidebar_layout = $packers_movers_company_post_sidebar;
}
if ( ! is_active_sidebar( 'sidebar-1' ) || $packers_movers_company_global_sidebar_layout == 'no-sidebar' ) {
    return;
}

if ($packers_movers_company_global_sidebar_layout == 'left-sidebar') {

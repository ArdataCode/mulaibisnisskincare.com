...
define('MOVIE_CINEMA_BLOCKS_BUY_NOW',__('https://www.wpradiant.net/products/cinema-wordpress-theme/','movie-cinema-blocks'));
define('MOVIE_CINEMA_BLOCKS_DOC_URL',__('https://preview.wpradiant.net/tutorial/movie-cinema-blocks/','movie-cinema-blocks'));
define('MOVIE_CINEMA_BLOCKS_LIVE_DEMO',__('https://preview.wpradiant.net/movie-cinema-blocks/','movie-cinema-blocks'));
define('MOVIE_CINEMA_BLOCKS_PRO_DOC',__('https://preview.wpradiant.net/tutorial/movie-cinema-blocks-pro/','movie-cinema-blocks'));
	...
	<div class="movie-cinema-blocks-appearence wrap about-wrap">
		...
		<div class="four-col">
			...
			<div class="col">
				...
				<h3><i class="dashicons dashicons-book-alt"></i><?php esc_html_e( 'Free Theme Directives', 'movie-cinema-blocks' ); ?></h3>

				<p>
					<?php esc_html_e( 'This article will walk you through the different phases of setting up and handling your WordPress website.', 'movie-cinema-blocks' ); ?>
				</p>

				<p>
					<a class="button green button-primary" href="<?php echo esc_url( MOVIE_CINEMA_BLOCKS_DOC_URL ); ?>" target="_blank"><?php esc_html_e( 'Free Documentation', 'movie-cinema-blocks' ); ?></a>
				</p>
